...
def save_dict_to_file(dictionary, filename = "dict_" , dir_path = None, doc_string = "Dictionary for ICD-10 count tracking" ):
    """
...
def mapping_fn_with_hpo3_plus_orpha_api(data):
    """
    FUNCTION FROM PREVIOUS DATA SCIENTIST
